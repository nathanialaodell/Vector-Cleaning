...
The primary cleaning file, 'Sweep and Mop.R', is broken up into two sections.

The first, 'sweep', is a function that takes a raw, potentially messy .csv, .xlsx, or .xls file and both cleans and standardizes species collection and geospatial information. The following table describes the functions arguments.
